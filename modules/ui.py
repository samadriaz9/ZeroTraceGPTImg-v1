...
def create_ui():
    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Tab("Generation", id="txt2img_generation") as txt2img_generation_tab, ResizeHandleRow(equal_height=False):
            ...
            # ChatGPT Integration Connections - Only connect if API key is available
            try:
                chatgpt_available = chatgpt_integration.is_chatgpt_available()
            except:
                chatgpt_available = False
            
            if chatgpt_available and hasattr(toprow, 'enhance_prompt_btn') and toprow.enhance_prompt_btn is not None:
            ...
            elif hasattr(toprow, 'chatgpt_row') and toprow.chatgpt_row is not None:
                # Hide the ChatGPT row if API key is not available
                toprow.chatgpt_row.visible = False
    ...
    with gr.Blocks(analytics_enabled=False) as img2img_interface:
        ...
        with gr.Tab("Generation", id="img2img_generation") as img2img_generation_tab, ResizeHandleRow(equal_height=False):
            ...
            # ChatGPT Integration Connections for img2img - Only connect if API key is available
            try:
                chatgpt_available = chatgpt_integration.is_chatgpt_available()
            except:
                chatgpt_available = False
