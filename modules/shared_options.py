...
categories.register_category("sd", "AI Image Generation")
...
options_templates.update(options_section(('sd', "AI Image Generation", "sd"), {
    "sd_model_checkpoint": OptionInfo(None, "AI Image Generation checkpoint", gr.Dropdown, lambda: {"choices": shared_items.list_checkpoint_tiles(shared.opts.sd_checkpoint_dropdown_use_short)}, refresh=shared_items.refresh_checkpoints, infotext='Model hash'),
...
options_templates.update(options_section(('sdxl', "AI Image Generation XL", "sd"), {
...
options_templates.update(options_section(('sd3', "AI Image Generation 3", "sd"), {
...
image into latent space representation and back. Latent space representation is what AI image generation is working on during sampling
